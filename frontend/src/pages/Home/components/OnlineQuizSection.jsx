...
export function OnlineQuizSection() {
    return (
        <section className="container grid grid-cols-2 items-center mt-40 bg-[#8253f5]/5 p-5 rounded-xl">
                ...
                <div>
                    <div className="flex flex-col gap-5">
                        ...
                        <p className="text-sm text-text-secondary leading-8">
                            آزمون های آنلاین متنوع و زمان دار برگزار کنید و نتایج را به صورت خودکار و دقیق بررسی
                            و
                            تحلیل کنید
                        </p>
                    </div>
            ...
            <figure className="flex justify-end">
                <img className="w-[60%]" src="/img/quiz.png" alt="assignment image"/>
            </figure>
        </section>
    )
}