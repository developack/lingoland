            ...
            <div className="container grid grid-cols-[3fr_1fr] gap-10 flex-1 mt-20 items-start">
                            ...
                            return (
                                <div key={course.id} className="rounded-xl bg-white overflow-hidden">
                                    <figure className="flex">
                                        <img className="w-full h-50 object-cover" src={`${BASE_URL}${course.thumbnail}`} alt={course.title}/>
                                    </figure>
                                    <div className="p-5">
                                        <div className="flex flex-col gap-2">
                ...
                <aside className="bg-white rounded-xl p-5">
                    ...
                    <div className="flex flex-col gap-3 text-sm mt-5">
                        <button type="button" className="text-white bg-primary rounded-xl p-3 cursor-pointer">اعمال فیلترها</button>
                        <button type="button" className="bg-white shadow-md rounded-xl p-3 cursor-pointer">پاک کردن همه</button>
                    </div>
                </aside>
            </div>
